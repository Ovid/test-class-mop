package Test::Class::MOP::Load;

# ABSTRACT: Load L<Test::Class::MOP> classes automatically.
...
=head1 SYNOPSIS
 ...
 use Test::Class::MOP::Load qw(t/tests t/lib);
 Test::Class::MOP->runtests;
...
L<Test::Class::MOP> typically uses a helper script to load the test classes.
...
L<Test::Class::MOP::Load> automatically finds and loads your test classes
for you. There is no longer a need to list them individually.

=head1 BASIC USAGE

Using L<Test::Class::MOP::Load> is as simple as this:
 ...
 use Test::Class::MOP::Load 't/tests';

 Test::Class::MOP->new(\%args)->runtests;
...
Here's some examples of advanced usage of L<Test::Class::MOP::Load>.
...
L<Test::Class::MOP::Load> overriding the C<is_test_class()> method. You
might want to do this to only load modules which inherit from
L<Test::Class::MOP>, or anything else for that matter. 
...
and be loaded by L<Test::Class::MOP::Load>. The default filter simply
...
For example:
  ...
  package My::Loader;
  use base qw( Test::Class::MOP::Load );
...
class which runs the tests for you.  It might looks something like this:
 ...
 package My::Test::Class::MOP;
 
 use strict;
 use warnings;

 use base 'Test::Class::MOP';

 INIT { Test::Class::MOP->new->runtests } # here's the magic!
...
to run:
 ...
 prove -lv -It/tests Some::Test::Class::MOP
...
L<Test::Class::MOP::Load> is taint safe.  Because we're reading the class
